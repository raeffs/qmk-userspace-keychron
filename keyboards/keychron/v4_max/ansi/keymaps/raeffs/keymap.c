...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_61(
        ...
        MO(_FN3),KC_A,     KC_S,    KC_D,     KC_F,      KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,
    ...
    [_FN1] = LAYOUT_ansi_61(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUD,  RGB_SAI,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,           RGB_RMOD, RGB_VAD,  RGB_HUI,  RGB_SAD,  RGB_SPD,  _______,  _______,  _______,  _______,  _______,            _______,
    ...
    [_FN3] = LAYOUT_ansi_61(
        ...
        _______,  _______, _______,  _______,  _______,  _______,  KC_PGUP,  KC_UUML,  KC_UP,    KC_OUML,  KC_PSCR,  _______,  _______,  _______,
        _______,  KC_AUML, _______,  _______,  _______,  _______,  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  _______,  _______,            _______,
