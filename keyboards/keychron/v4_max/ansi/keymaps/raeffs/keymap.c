...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN3] = LAYOUT_ansi_61(
        ...
        _______,  _______, _______,  _______,  _______,  _______,  _______,  KC_UUML,  _______,  KC_OUML,  _______,  _______,  _______,  _______,
        _______,  KC_AUML, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
